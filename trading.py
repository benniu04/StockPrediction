...
def is_market_closed():
    ...
    us_holidays = holidays.US()  # For U.S. holidays (modify based on your country)
...
if is_market_closed():
    ...
    X = stock_data[
        ['Open', 'High', 'Low', 'Volume', 'Prev Close', 'Low_Close_Diff', 'SMA_Low_50', 'Lower_BB', 'Upper_BB',
         'Low_Close_Diff_Volume', 'EMA_100', 'Lag_10', 'Sentiment']]
    ...
    # Stack predictions as features for the metamodel
